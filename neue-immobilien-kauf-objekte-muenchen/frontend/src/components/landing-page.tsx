    ...
    <div ref={rootRef} className="min-h-screen bg-white text-slate-900">
      <header className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-white/80 backdrop-blur-md">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <button onClick={() => setOpen(true)} className="rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm font-medium shadow-sm transition hover:bg-slate-50">Login</button>
        </div>
      </header>
      ...
      <main>
        <section data-hero className="relative flex min-h-[90vh] items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-4 py-32 text-center sm:px-6 lg:px-8">
            <h1 data-reveal className="mx-auto max-w-4xl text-4xl font-bold leading-tight text-white sm:text-5xl lg:text-6xl">Finden Sie Immobilien schneller als alle anderen.</h1>
            ...
            <div data-reveal className="mt-10">
              <button onClick={() => setOpen(true)} className="rounded-2xl bg-emerald-700 px-8 py-4 text-base font-semibold text-white shadow-lg transition hover:bg-emerald-800">Contact Sales for Access</button>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div id="features-grid" className="mt-16 grid gap-8 md:grid-cols-3">
              {features.map((feature) => (
                <div key={feature.title} data-feature-card className="group rounded-2xl border border-slate-200 bg-white p-8 shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
