...
BROKER_CURATED_SOURCES = [
    ...
    {"name": "Knight Frank München", "base_url": "https://www.knightfrank.de/immobilien/muenchen", "kind": "broker"},
    {"name": "von Poll München", "base_url": "https://www.von-poll.com/de/immobilien/muenchen", "kind": "broker"},
    {"name": "Citigrund", "base_url": "https://www.citigrund.de/immobilienangebote/", "kind": "broker"},
    {"name": "Walser", "base_url": "https://www.walser-immobiliengruppe.de/immobilien/", "kind": "broker"},
    {"name": "Rohrer", "base_url": "https://www.rohrer-immobilien.de/immobilien/", "kind": "broker"},
    {"name": "Bayerische Hausbau", "base_url": "https://www.bayerischehausbau.de/immobilien/", "kind": "broker"},
    {"name": "Isaria", "base_url": "https://www.isaria.ag/projekte/", "kind": "broker"},
    {"name": "Bauwerk", "base_url": "https://www.bauwerk.de/projekte/", "kind": "broker"},
    {"name": "Pandion", "base_url": "https://www.pandion.de/projekte/", "kind": "broker"},
    {"name": "Ehret + Klein", "base_url": "https://ehret-klein.de/projekte/", "kind": "broker"},
    {"name": "Immosmart München", "base_url": "https://www.immosmart.de/immobilienangebote/", "kind": "broker"},
    {"name": "ImmoMünchen", "base_url": "https://www.immo-muenchen.de/", "kind": "broker"},
    {"name": "SIS Immobilien", "base_url": "https://www.sis-immobilien.de/immobilien/", "kind": "broker"},
    {"name": "Veltrup", "base_url": "https://www.veltrup.de/immobilien/", "kind": "broker"},
    {"name": "Heinlein", "base_url": "https://www.heinlein-immobilien.de/", "kind": "broker"},
    {"name": "Immobilientreff", "base_url": "https://www.immobilientreff.de/", "kind": "broker"},
    {"name": "Pienzenauer", "base_url": "https://www.pienzenauer.de/immobilien/", "kind": "broker"},
    {"name": "Schneider & Prell", "base_url": "https://www.schneider-prell.de/immobilien/", "kind": "broker"},
    {"name": "ImmoQuartier", "base_url": "https://www.immoquartier.de/angebote/", "kind": "broker"},
    {"name": "ImmoConcept München", "base_url": "https://www.immoconcept-muenchen.de/", "kind": "broker"},
]
