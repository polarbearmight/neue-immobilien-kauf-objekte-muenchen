...
SEARCH_URL = "https://www.ohne-makler.net/immobilie-kaufen/bayern/muenchen/wohnung/"
...
def collect_ohne_makler_listings() -> list[dict]:
    c = SafeCollector()
    c.assert_allowed("https://www.ohne-makler.net/robots.txt", "/immobilie-kaufen/bayern/muenchen/wohnung/")
    try:
